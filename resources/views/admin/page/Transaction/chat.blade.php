                        ...
                        <div class="overflow-x-auto scrollbar-hidden">
                            <div class="flex mt-5">
                                <a href="" class="w-10 mr-4 cursor-pointer">
                                    ...
                                    <div class="text-xs text-slate-500 truncate text-center mt-2">Sean Connery</div>
                                </a>
                                <a href="" class="w-10 mr-4 cursor-pointer">
                                    <div class="w-10 h-10 flex-none image-fit rounded-full">
                                        <img alt="Midone - HTML Admin Template" class="rounded-full" src="{{asset('dist/images/profile-6.jpg')}}">
                                ...
                                <a href="" class="w-10 mr-4 cursor-pointer">
                                    ...
                                    <div class="text-xs text-slate-500 truncate text-center mt-2">John Travolta</div>
                                </a>
                                <a href="" class="w-10 mr-4 cursor-pointer">
                                    <div class="w-10 h-10 flex-none image-fit rounded-full">
                                        <img alt="Midone - HTML Admin Template" class="rounded-full" src="{{asset('dist/images/profile-6.jpg')}}">
                    ...
                    <div class="intro-x cursor-pointer box relative flex items-center p-5 ">
                        ...
                        <div class="ml-2 overflow-hidden">
                            <div class="flex items-center">
                                <a href="javascript:;" class="font-medium">Sean Connery</a> 
            ...
            <div id="friends" class="tab-pane" role="tabpanel" aria-labelledby="friends-tab">
                ...
                <div class="chat__user-list overflow-y-auto scrollbar-hidden pr-1 pt-1">
                    ...
                    <div class="cursor-pointer box relative flex items-center p-5 mt-5">
                        ...
                        <div class="ml-2 overflow-hidden">
                            <div class="flex items-center"> <a href="" class="font-medium">Sean Connery</a> </div>
                ...
                <div class="pr-1">
                    <div class="box px-5 py-10 mt-5">
                        ...
                        <div class="text-center mt-3">
                            <div class="font-medium text-lg">Sean Connery</div>
                    ...
                    <div class="box p-5 mt-5">
                        ...
                        <div class="flex items-center border-b border-slate-200/60 dark:border-darkmode-400 py-5">
                            <div>
                                ...
                                <div class="mt-1">seanconnery@left4code.com</div>
                            </div>
                        ...
                        <div class="flex items-center pt-5">
                            <div>
                                ...
                                <div class="mt-1">29 October 2020</div>
                            </div>
        ...
        <div class="chat__box box">
                ...
                <div class="flex flex-col sm:flex-row border-b border-slate-200/60 dark:border-darkmode-400 px-5 py-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3 mr-auto">
                            <div class="font-medium text-base">Sean Connery</div>
            ...
            <div class="h-full flex items-center">
                <div class="mx-auto text-center">
                    ...
                    <div class="mt-3">
                        <div class="font-medium">Hey, Sean Connery!</div>

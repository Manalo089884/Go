...
"use strict";
/*!*******************************************!*\
  !*** ./resources/js/phil-conv-address.js ***!
  \*******************************************/
...
var convertAddresses = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var tbody, _iterator, _step, _loop;

    return _regeneratorRuntime().wrap(function _callee$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            tbody = document.querySelector("#addressTbody");
            _iterator = _createForOfIteratorHelper(tbody.querySelectorAll('tr'));
            _context2.prev = 2;
            _loop = /*#__PURE__*/_regeneratorRuntime().mark(function _loop() {
              var element, addressCell, _addressCell$textCont, _addressCell$textCont2, provinceCode, cityCode, brgyCode, cityList, city, brgyList, brgy, provinces, province;
              ...
              return _regeneratorRuntime().wrap(function _loop$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      element = _step.value;
                      addressCell = element.querySelector(".address"); //Getting the value of the tr address

                      _addressCell$textCont = addressCell.textContent.split("-"), _addressCell$textCont2 = _slicedToArray(_addressCell$textCont, 3), provinceCode = _addressCell$textCont2[0], cityCode = _addressCell$textCont2[1], brgyCode = _addressCell$textCont2[2]; //Get City Name

                      _context.next = 5;
                      return (0,select_philippines_address__WEBPACK_IMPORTED_MODULE_0__.cities)(provinceCode);

                    case 5:
                      cityList = _context.sent;
                      city = cityList.find(function (c) {
                        return c.city_code === cityCode;
                      }); // Get Barangay Name

                      _context.next = 9;
                      return (0,select_philippines_address__WEBPACK_IMPORTED_MODULE_0__.barangays)(cityCode);

                    case 9:
                      brgyList = _context.sent;
                      brgy = brgyList.find(function (b) {
                        return b.brgy_code === brgyCode;
                      }); //Get Provuce Name

                      _context.next = 13;
                      return (0,select_philippines_address__WEBPACK_IMPORTED_MODULE_0__.provincesByCode)(city.region_desc);
                    ...
                    case 13:
                      ...
                      addressCell.innerText = "".concat(province.province_name, "-").concat(city.city_name, "-").concat(brgy.brgy_name);
  ...
  return function convertAddresses() {

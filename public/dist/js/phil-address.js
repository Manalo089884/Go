...
var populateAddressInputs = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var r, findSelectById, provinceSelect, citySelect, barangaySelect, _iterator, _step, reg, p, _iterator4, _step4, prov;
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return (0,select_philippines_address__WEBPACK_IMPORTED_MODULE_0__.regions)();

          case 2:
            r = _context3.sent;

            findSelectById = function findSelectById(id) {
            ...
            provinceSelect = window.tomSelects.find(findSelectById("Province"));
            citySelect = window.tomSelects.find(findSelectById("city"));
            barangaySelect = window.tomSelects.find(findSelectById("barangay")); //populate provinces select

            _iterator = _createForOfIteratorHelper(r);
            _context3.prev = 8;
          ...
          case 10:
            ...
            reg = _step.value;
            _context3.next = 14;
            return (0,select_philippines_address__WEBPACK_IMPORTED_MODULE_0__.provinces)(reg.region_code);
          ...
          case 27:
            ...
            provinceSelect.on("change", /*#__PURE__*/function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(value) {
                var c, _iterator2, _step2, city;
                ...
                return _regeneratorRuntime().wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        _context.next = 2;
                        return (0,select_philippines_address__WEBPACK_IMPORTED_MODULE_0__.cities)(value);

                      case 2:
                        c = _context.sent;
                        citySelect.clear();
                        citySelect.clearOptions();
                        _iterator2 = _createForOfIteratorHelper(c);
            ...
            citySelect.on("change", /*#__PURE__*/function () {
              var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(value) {
                var b, _iterator3, _step3, barangay;
                ...
                return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        _context2.next = 2;
                        return (0,select_philippines_address__WEBPACK_IMPORTED_MODULE_0__.barangays)(value);

                      case 2:
                        b = _context2.sent;
                        barangaySelect.clear();
                        barangaySelect.clearOptions();
                        _iterator3 = _createForOfIteratorHelper(b);

                        try {
                          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
                            barangay = _step3.value;
                            barangaySelect.addOption({
                              value: barangay.brgy_code,
                              text: barangay.brgy_name
                            });
                          }
                        } catch (err) {
                          _iterator3.e(err);
  ...
  return function populateAddressInputs() {
